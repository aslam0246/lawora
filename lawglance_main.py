...
class Lawglance:
    ...
    def conversational(self, query, session_id, metadata_filter=None, return_citations=False):
        """
        ...
        rag_chain = get_rag_chain(self.llm, self.vector_store, SYSTEM_PROMPT, QA_PROMPT, metadata_filter=metadata_filter)
        ...
        citations = response.get('context', []) if return_citations else []
        ...
        if return_citations:
            return {"answer": answer, "citations": citations}, chat_history_obj.messages
